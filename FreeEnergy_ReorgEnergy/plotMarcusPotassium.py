...
phi0, betaF_phi0 = read_data('potassium/lTF_0/FES/forward.txt',0,1,1,0)
phi0o, betaF_phi0o = read_data('potassium/lTF_0/FES/backward.txt',0,1,1,0)
phi2, betaF_phi2 = read_data('potassium/lTF_2/FES/forward.txt',0,1,1,0)
phi2o, betaF_phi2o = read_data('potassium/lTF_2/FES/backward.txt',0,1,1,0)
phi5, betaF_phi5 = read_data('potassium/lTF_5/FES/forward.txt',0,1,1,0)
phi5o, betaF_phi5o = read_data('potassium/lTF_5/FES/backward.txt',0,1,1,0)
phi_inf, betaF_phi_inf = read_data('potassium/lTF_inf/FES/forward.txt',0,1,1,0)
phio_inf, betaF_phio_inf = read_data('potassium/lTF_inf/FES/backward.txt',0,1,1,0)
...
phi0-=124.331-dF0
phi0o-=124.331-dF0
phi_inf-=123.0015-dFinf
phio_inf-=123.0015-dFinf
...
phim12,meanm12 = read_datmean('potassium/lTF_2/Egap_data/lambdam1/sample.txt',0,1,1)
phi02,mean02 = read_datmean('potassium/lTF_2/Egap_data/lambda0/sample.txt',0,1,1)
phi12,mean12 = read_datmean('potassium/lTF_2/Egap_data/lambda1/sample.txt',0,1,1)
phi22,mean22 = read_datmean('potassium/lTF_2/Egap_data/lambda2/sample.txt',0,1,1)
phi32,mean32 = read_datmean('potassium/lTF_2/Egap_data/lambda3/sample.txt',0,1,1)
phi42,mean42 = read_datmean('potassium/lTF_2/Egap_data/lambda4/sample.txt',0,1,1)
phi52,mean52 = read_datmean('potassium/lTF_2/Egap_data/lambda5/sample.txt',0,1,1)
phiTS2,meanTS2 = read_datmean('potassium/lTF_2/Egap_data/lambdaTS/sample.txt',0,1,1)
phip12,meanp12 = read_datmean('potassium/lTF_2/Egap_data/lambdap1/sample.txt',0,1,1)

phim1inf,meanm1inf = read_datmean('potassium/lTF_inf/Egap_data/lambdam1/sample.txt',0,1,1)
phi0inf,mean0inf = read_datmean('potassium/lTF_inf/Egap_data/lambda0/sample.txt',0,1,1)
phi1inf,mean1inf = read_datmean('potassium/lTF_inf/Egap_data/lambda1/sample.txt',0,1,1)
phi2inf,mean2inf = read_datmean('potassium/lTF_inf/Egap_data/lambda2/sample.txt',0,1,1)
phi3inf,mean3inf = read_datmean('potassium/lTF_inf/Egap_data/lambda3/sample.txt',0,1,1)
phi4inf,mean4inf = read_datmean('potassium/lTF_inf/Egap_data/lambda4/sample.txt',0,1,1)
phi5inf,mean5inf = read_datmean('potassium/lTF_inf/Egap_data/lambda5/sample.txt',0,1,1)
phiTSinf,meanTSinf = read_datmean('potassium/lTF_inf/Egap_data/lambdaTS/sample.txt',0,1,1)
phip1inf,meanp1inf = read_datmean('potassium/lTF_inf/Egap_data/lambdap1/sample.txt',0,1,1)

phim10,meanm10 = read_datmean('potassium/lTF_0/Egap_data/lambdam1/sample.txt',0,1,1)
phi00,mean00 = read_datmean('potassium/lTF_0/Egap_data/lambda0/sample.txt',0,1,1)
phi10,mean10 = read_datmean('potassium/lTF_0/Egap_data/lambda1/sample.txt',0,1,1)
phi20,mean20 = read_datmean('potassium/lTF_0/Egap_data/lambda2/sample.txt',0,1,1)
phi30,mean30 = read_datmean('potassium/lTF_0/Egap_data/lambda3/sample.txt',0,1,1)
phi40,mean40 = read_datmean('potassium/lTF_0/Egap_data/lambda4/sample.txt',0,1,1)
phi50,mean50 = read_datmean('potassium/lTF_0/Egap_data/lambda5/sample.txt',0,1,1)
phiTS0,meanTS0 = read_datmean('potassium/lTF_0/Egap_data/lambdaTS/sample.txt',0,1,1)
phip10,meanp10 = read_datmean('potassium/lTF_0/Egap_data/lambdap1/sample.txt',0,1,1)

phim15,meanm15 = read_datmean('potassium/lTF_5/Egap_data/lambdam1/sample.txt',0,1,1)
phi05,mean05 = read_datmean('potassium/lTF_5/Egap_data/lambda0/sample.txt',0,1,1)
phi15,mean15 = read_datmean('potassium/lTF_5/Egap_data/lambda1/sample.txt',0,1,1)
phi25,mean25 = read_datmean('potassium/lTF_5/Egap_data/lambda2/sample.txt',0,1,1)
phi35,mean35 = read_datmean('potassium/lTF_5/Egap_data/lambda3/sample.txt',0,1,1)
phi45,mean45 = read_datmean('potassium/lTF_5/Egap_data/lambda4/sample.txt',0,1,1)
phi55,mean55 = read_datmean('potassium/lTF_5/Egap_data/lambda5/sample.txt',0,1,1)
phiTS5,meanTS5 = read_datmean('potassium/lTF_5/Egap_data/lambdaTS/sample.txt',0,1,1)
phip15,meanp15 = read_datmean('potassium/lTF_5/Egap_data/lambdap1/sample.txt',0,1,1)

# Average energy gap in biased ensembles
means2 = np.array([meanm12,mean02,mean12,mean22,meanTS2,mean32,mean42,mean52,meanp12])- 124.7485                               
means0 = np.array([meanm10,mean00,mean10,mean20,meanTS0,mean30,mean40,mean50,meanp10]) - 124.331                              
means5 = np.array([meanm15,mean05,mean15,mean25,meanTS5,mean35,mean45,mean55,meanp15])-123.0015                               
meansinf = np.array([meanm1inf,mean0inf,mean1inf,mean2inf,meanTSinf,mean3inf,mean4inf,mean5inf,meanp1inf])-123.811
...
fig.tight_layout()
plt.savefig('MarcusPotassiumSI.png')
plt.show()
